...
//import { UserRound, ShoppingCart, Newspaper, BellRing, Paperclip, LogOut,Brush, Wrench } from 'lucide-react'
            ...
            <form className="mt-8 space-y-6" action="#" method="POST">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-medium text-blue-600 hover:text-green-500">
              ...
              <div>
                ...
                >
                  <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                    <ArrowRight className="h-5 w-5 text-blue-500 group-hover:text-green-400" />
                  </span>
                  Sign up
                </button>
              </div>
